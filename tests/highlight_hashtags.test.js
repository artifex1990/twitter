...
describe('Функция highlightHashtags', () => {
  it('должна обрабатывать одиночный хэш-тег в середине текста', () => {
  ...
  it('должна обрабатывать несколько хэш-тегов', () => {
  ...
  it('должна обрабатывать хэш-теги с цифрами', () => {
  ...
  it('должна обрабатывать смежные хэш-теги', () => {
